package
{
   ...
   public class LockpickingMenu extends IMenu
   {
      ...
      public function LockpickingMenu()
      {
         ...
         this.LockLevelText.visible = false;
         this.NumLockpicksText.visible = false;
      }
      ...
      public function UpdatePickAngle(param1:Number) : void
      {
         ...
         this.DebugDisplay_mc.PickIndicator_mc.x = this.PickAngleToXInv(param1);
      }
      ...
      private function PickAngleToXInv(param1:Number) : Number
      {
         var _loc2_:Number = 1 - (param1 - this.fPickMinAngle) / (this.fPickMaxAngle - this.fPickMinAngle);
         return this.DebugDisplay_mc.SweetSpotRects_mc.x + this.iDebugRectBaseWidth * _loc2_;
      }
      ...
      {
         GlobalFunc.SetText(this.LockLevelText,"$Lock_Skill_Level");
         GlobalFunc.SetText(this.LockLevelText,this.LockLevelText.text.replace("{1}",arguments[0]));
         ...
         this.LockLevelText.visible = !bNuclearWinterMode;
         this.NumLockpicksText.visible = !bNuclearWinterMode;
      }
   }
}
